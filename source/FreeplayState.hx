...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		add(textBG);
		#if PRELOAD_ALL
		var leText:String = "Press the play button to listen to this Song / Press the trash button to Reset your Score and Accuracy.";
		#else
		var leText:String = "Press the trash button to Reset your Score and Accuracy.";
		#end
